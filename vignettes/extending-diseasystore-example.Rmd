...
Therefore, we immediately see a difference in the function signature of the `compute()` function, where we include
...
the birthday to the next birthday. Notice that we sometimes compute birth days that fall outside of the study period,
