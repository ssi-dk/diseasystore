...
```{r ds_map, eval = FALSE}                                                                                             # nolint start: object_name_linter, indentation_linter
...
```{r feature_handler_birth, eval = FALSE}                                                                              # nolint start: indentation_linter
  private = list(
    ...
...
```{r feature_handler_sex, eval = FALSE}                                                                                # nolint start: indentation_linter
  private = list(
    ...
...
```{r feature_handler_age, eval = FALSE}                                                                                # nolint start: indentation_linter
  private = list(
    ...
...
```{r feature_handler_n_positive, eval = FALSE}                                                                         # nolint start: indentation_linter
  private = list(
    ...
...
```{r feature_handler_n_hospital, eval = FALSE}                                                                         # nolint start: indentation_linter
  private = list(
    ...
...
```{r feature_handler_n_admission, eval = FALSE}                                                                        # nolint start: indentation_linter
  private = list(
    ...
...
All `diseasystores` require a database to store its features in. For convenience, we here set the `target_conn` option,
for all `diseasystores`[^3].
...
```{r initializing_diseasystore, eval = suggests_available}                                                             # nolint start: undesirable_operator_linter
...
ggplot2::ggplot(data1, ggplot2::aes(x = date, y = n_positive, color = age_group)) +
  ggplot2::geom_line() +
...
data2 <- ds$key_join_features(
  ...
  stratification = rlang::quos(
    generation = dplyr::case_when(
      lubridate::year(birth) < 1946 ~ "Silent",
...
ggplot2::ggplot(data2, ggplot2::aes(x = date, y = n_admission, color = generation)) +
  ggplot2::geom_line()
```
