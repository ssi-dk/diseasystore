...
# If we are on CRAN, use the newest benchmark (version = sha) and keep only
# CRAN SCDB results.
# This benchmark is then labelled with the neweset version number of diseasystore
# (the one we just deployed to CRAN)
if (on_cran) {
