...
not_on_cran <- interactive() || as.logical(Sys.getenv("NOT_CRAN", unset = "false")) || as.logical(Sys.getenv("CI", unset = "false"))interactive() || as.logical(Sys.getenv("NOT_CRAN", unset = "true"))
```
