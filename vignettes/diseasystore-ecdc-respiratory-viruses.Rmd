...
not_on_cran <- interactive() || as.logical(Sys.getenv("NOT_CRAN", unset = "true"))
```

The Respiratory viruses weekly repository contains weekly summaries of the [erviss](https://erviss.org/) data for
...
if (!file.exists(file.path(local_conn, test_file))) {
  remote_file <- diseasystore:::source_conn_github(
