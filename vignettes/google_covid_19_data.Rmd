...
target_conn <- \() {
  DBI::dbConnect(RSQLite::SQLite(), "/local/file/path/diseasystore_google_covid_19.sqlite")
}
...
ds <- DiseasystoreGoogleCovid19$new(start_date, end_date)
```
