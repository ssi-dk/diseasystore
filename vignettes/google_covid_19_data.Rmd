---
title: "Disesystore: Google COVID-19 data"
...
options(diseasystore.DiseasystoreGoogleCovid19.target_conn = \() dbConnect(RSQLite::SQLite(), "/local/file/path/diseasystore_google_covid_19.sqlite")) 
```
