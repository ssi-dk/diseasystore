...
stopifnot("DuckDB no longer has verbose messages" = !identical(t$messages, character(0)))
# If this fails, duckdb has removed the message and we can remove this section
```
