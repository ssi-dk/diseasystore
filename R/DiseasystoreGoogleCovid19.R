...
DiseasystoreGoogleCovid19 <- R6::R6Class( # nolint: object_name_linter.
  ...
  private = list(
    .ds_map = list("google_covid_19_population"      = "n_population",
                   "google_covid_19_age_group"       = "age_group",
                   "google_covid_19_index"           = "country_id",
                   "google_covid_19_index"           = "country",
                   "google_covid_19_index"           = "region_id",
                   "google_covid_19_index"           = "region",
                   "google_covid_19_index"           = "subregion_id",
                   "google_covid_19_index"           = "subregion",
                   "google_covid_19_hospital"        = "n_hospital",
                   "google_covid_19_deaths"          = "n_deaths",
                   "google_covid_19_positive"        = "n_positive",
                   "google_covid_19_icu"             = "n_icu",
                   "google_covid_19_ventilator"      = "n_ventilator",
                   "google_covid_19_min_temperature" = "min_temperature",
                   "google_covid_19_max_temperature" = "max_temperature"),
