...
#' * `get_lock_owner` returns the process id (pid) associated with the lock on db_table in target_schema.lock
...
#' @return Most are called for side effects. `get_lock_owner` returns the pid of the process that can modify the table.
#' @examples
...
#' @rdname db_locks
#' @export
get_lock_owner <- function(conn, db_table, schema = NULL) {
